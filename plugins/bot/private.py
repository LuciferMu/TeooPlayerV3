...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.lower() == "replay":
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/itsTat"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/aiiaa"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/itsTat"),
            ],
            [
